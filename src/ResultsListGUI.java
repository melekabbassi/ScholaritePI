...
public class ResultsListGUI extends JFrame {
    private final int WIDTH = (int) Toolkit.getDefaultToolkit().getScreenSize().getWidth();
    private final int HEIGHT = (int) Toolkit.getDefaultToolkit().getScreenSize().getHeight();

    public ResultsListGUI(String role) {
        ...
        // make a menu item
        JButton btnTeacherList = new JButton("Teachers List");
        btnTeacherList.setBounds(-30, 50, 300, 50);
        btnTeacherList.setForeground(new java.awt.Color(255, 255, 255));
        ...
        JButton resultListButton = new JButton("Results List");
        resultListButton.setBounds(-30, 250, 300, 50);
        resultListButton.setForeground(new java.awt.Color(34, 44, 62));
        resultListButton.setFont(new java.awt.Font("Roboto", 2, 20));
        resultListButton.setBackground(new java.awt.Color(42, 217, 152));
        resultListButton.setBorder(null);
        resultListButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        add(resultListButton);
        ...
        // String[] columnNames = { "ResultsID", "First Name", "Last Name", "Email" };
        // Object[][] data = { /*
        ...
        // make a table header
        JLabel lblTableHeader = new JLabel("Results List");
        ...
        // on click open add Results page
        ...
        // on click open delete Results page
        btnDelete.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                //new DeleteResultsGUI();
            }
        });
        ...
        // on click open update Results page
        btnUpdate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                //new UpdateResultsGUI();
            }
        });
        setVisible(true);
    }
    ...
    public JTable populateTable() {
        ...
        String[] columnNames = { "Results ID", "Average", "Student ID", "Email" };
        ...
        try {
            ...
            while (rs.next()) {
                String id = rs.getString("Results_code");
                String av = rs.getString("Average");
                String sid = rs.getString("Student_id");
                String mail = rs.getString("mail");
                model.addRow(new Object[] { id, av, sid, mail });
            }
        } catch (Exception ex) {
    ...
    public JTable SearchInTabe(String value) {
        ...
        try {
            ...
            final String PASSWORD = "";
            Connection conn = DriverManager.getConnection(DB_URL, USERNAME, PASSWORD);
            String sql = "select * from Resultss where StudentID = ? or Result_code = ?";
            PreparedStatement ps = conn.prepareStatement(sql);
